            ...
            if (jtarget.length > 0) {
                try {
                    jQuery('html, body').stop().animate({
                        'scrollTop': (jtarget.offset().top - 50)
                    }, 900, 'swing', function () {
    ...
    $(document).ready(function () {
        ...
        if (window_width > 992) {
            ...
            $(body).on("click", ".menu-cnt > ul > li > a,.lan-menu a", function () {
                ...
                $(body).find(" div > nav .menu-cnt > ul > li,.shop-menu-cnt,.lan-menu li").removeClass("active");
        ...
        if (window_width > 992) {
            ...
            footer_parallax = $(body).find(" div > footer.footer-parallax");
        ...
        $(body).find(' div > #preloader').fadeOut(300);
        setTimeout(function () {
